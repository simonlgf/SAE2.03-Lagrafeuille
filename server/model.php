...
function getAllMovies($age){
    ...
    $sql = "SELECT Movie.id, Movie.name, Movie.image, Movie.year, Movie.length, Movie.director, Category.name as category, Category.description as category_description
            FROM Movie
